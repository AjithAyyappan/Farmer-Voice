...
String fid="a"+String.format("%05d",random.nextInt(100000));
...
int i=st.executeUpdate("insert into news values('"+user+"','"+feed+"','"+time+"','"+fid+"')");
int j=st.executeUpdate("create table "+fid+" (user varchar(20) unique)");
...
ResultSet r;
int k=s.executeUpdate("create table "+fid+"(user varchar(20),rep varchar(3000),vote int(4),time varchar(20),rid varchar(10))ENGINE=MyISAM DEFAULT CHARSET=utf8");
java.sql.Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/vote","root","Data@123");
Statement stt=conn.createStatement();
int l=stt.executeUpdate("create table "+fid+" (user varchar(20) unique)");
%>
<p>Your feed is posted Successfully</p><br><br><br>
<p>To view your post press continue:</p>
<a href="nfeed.jsp" ><button type="submit"  value="CONTINUE" >CONTINUE</button></a>
